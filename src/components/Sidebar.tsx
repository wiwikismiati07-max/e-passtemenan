      ...
      >
        ...
        <div className="p-3.5 sm:p-4 border-b border-slate-100 dark:border-slate-800/80 shrink-0">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="p-1.5 text-slate-400 hover:text-slate-700 dark:hover:text-white rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors flex items-center gap-1 text-xs font-bold cursor-pointer"
        ...
        <div className="p-3 border-t border-slate-200/90 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-900/95 space-y-2 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 py-2 px-3 bg-cyan-50 dark:bg-cyan-950/60 border border-cyan-200 dark:border-cyan-800 hover:bg-cyan-100 dark:hover:bg-cyan-900/70 text-cyan-700 dark:text-cyan-300 rounded-xl text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors shadow-2xs cursor-pointer"
