...
export const PilihanMenuPortal: React.FC<PilihanMenuPortalProps> = ({
  ...
  const appCards = [
    ...
    },
    {
      ...
      fullTitle: 'SURAT PERJANJIAN DAMAI SISWA',
      subtitle: 'PENYELESAIAN PERSELISIHAN',
      category: 'inovasi',
      icon: Handshake,
      iconGradient: 'from-[#059669] via-[#10b981] to-[#34d399] shadow-emerald-500/30',
      action: () => onNavigate('sp-damai', 'form'),
    },
    {
      id: 'arsip-kegiatan-portal',
      title: 'ARSIP KEGIATAN',
      fullTitle: 'ARSIP & DOKUMENTASI KEGIATAN',
      subtitle: 'GALERI & DOKUMENTASI GOOGLE SITE',
      category: 'inovasi',
      icon: FolderArchive,
      iconGradient: 'from-[#2563eb] via-[#4f46e5] to-[#6366f1] shadow-indigo-500/30',
      action: () => window.open('https://sites.google.com/view/berandapasstemenanspanju/home', '_blank'),
    },
  ];
