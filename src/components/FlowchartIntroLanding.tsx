...
export const FlowchartIntroLanding: React.FC<FlowchartIntroLandingProps> = ({ onEnterApp }) => {
  ...
  const flowcharts = [
    ...
    },
    {
      ...
      primaryImg: 'https://images.weserv.nl/?url=i.ibb.co/XHSRvkR/Alur-Penilaian-Tolak-Ukur-Bagan-Keputusan.png&w=1200&output=jpg&q=85',
      fallbackImg: bagan2Img,
    ...
    },
    {
      ...
      primaryImg: 'https://images.weserv.nl/?url=i.ibb.co/spq7dvH0/Diagram-Alur-Penilaian-Respon-Laporan.png&w=1200&output=jpg&q=85',
      fallbackImg: bagan3Img,
