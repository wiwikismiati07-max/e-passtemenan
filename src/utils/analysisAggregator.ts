...
export function calculateClassZoneData(db: AppDatabase): ClassZoneInfo[] {
  ...
  INITIAL_CLASS_ZONE_DATA.forEach((cls) => {
    ...
    classMap.set(cls.namaKelas, {
      ...
      ikrarSiswa: custom?.ikrarSiswa || cls.ikrarSiswa,
      catatanKegiatan: custom?.catatanKegiatan || cls.catatanKegiatan,
      deklarasiDamai: custom?.deklarasiDamai !== undefined ? custom.deklarasiDamai : cls.deklarasiDamai,
      kasusVerbal: 0,
      kasusFisik: 0,
      kasusRelasional: 0,
      kasusSiber: 0,
